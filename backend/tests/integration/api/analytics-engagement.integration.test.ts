...
describe("Analytics Engagement API Integration Tests", () => {
  describe("GET /api/analytics/engagement", () => {
    describe("Authentication & Authorization", () => {
      it("should return 401 if not authenticated", async () => {
        const response = await request.get("/api/analytics/engagement");
      ...
      it("should return engagement analytics for Administrator role", async () => {
      ...
      it("should allow Super Admin to access engagement analytics", async () => {
