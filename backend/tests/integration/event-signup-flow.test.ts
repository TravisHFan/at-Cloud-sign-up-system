 ...
 *
 * Tests the core event signup functionality using Registration-based system.
 */
...
describe("🎯 Event Signup Flow Tests", () => {
  ...
  describe("Signup Cancellation", () => {
    ...
    it("should properly clean up data on cancellation", () => {
      // Ensure Registration collection is properly updated
      const cleanup = true;
  ...
  describe("Data Consistency", () => {
    it("should maintain data consistency in Registration collection", () => {
