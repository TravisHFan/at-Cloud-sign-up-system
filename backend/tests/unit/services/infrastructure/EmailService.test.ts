...
describe("EmailService", () => {
  ...
  // ===== Auth-related email tests moved to AuthEmailService.test.ts =====
  // Tests for: sendVerificationEmail, sendPasswordResetEmail,
  // sendPasswordChangeRequestEmail, sendPasswordResetSuccessEmail, sendWelcomeEmail
  // See: tests/unit/services/email/domains/AuthEmailService.test.ts
