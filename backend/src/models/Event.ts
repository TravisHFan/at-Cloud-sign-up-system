...
export interface IEvent extends Document {
  title: string;
  description: string;
  category: 'technology' | 'business' | 'health' | 'education' | 'sports' | 'entertainment' | 'other';
...
const eventSchema: Schema = new Schema(
  {
    ...
    category: {
      type: String,
      enum: ['technology', 'business', 'health', 'education', 'sports', 'entertainment', 'other'],
      required: [true, 'Event category is required']
    },
    type: {
      type: String,
      enum: ['conference', 'workshop', 'seminar', 'meetup', 'webinar', 'networking', 'other'],
