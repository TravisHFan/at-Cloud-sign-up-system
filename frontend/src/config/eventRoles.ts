...
// Only Communication Workshop roles are supported
// Other event types removed as per requirements
...
export const getRolesByEventType = (
  ...
  switch (eventTypeName) {
    ...
    default:
      return COMMUNICATION_WORKSHOP_ROLES; // Default fallback - only Communication Workshop supported
  }
};
