...
export default function EventDetail() {
  ...
  const canUsePastEventParticipantActions =
        ...
        <>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="flex items-center space-x-3 mb-6">
              {isPassedEvent ? (
                /* For passed events, show recordkeeping and participant email actions for authorized users */
                canUsePastEventParticipantActions ? (
                  <>
                    <button
