...
const iconPaths = {
  ...
  "shield-check":
    "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 7.04A12.02 12.02 0 0012 21c2.114 0 4.152-.546 5.918-1.5a2.4 2.4 0 00.7-3.32L12 9l-6 6",
  "user-plus":
    "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z M21 10h-6m3-3v6",
  trash:
    "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16",
  "trash-can":
    "M6 7V5a2 2 0 012-2h8a2 2 0 012 2v2h3v2h-1v11a2 2 0 01-2 2H6a2 2 0 01-2-2V9H3V7h3zm2-2v2h8V5H8zm1 4v9h2v-9H9zm4 0v9h2v-9h-2z",
  ...
  bell: "M10 5a2 2 0 114 0c0 7.84 3.5 9.32 4.5 10.5H5.5c1-1.18 4.5-2.66 4.5-10.5zm1.5 15a1.5 1.5 0 01-3 0",
