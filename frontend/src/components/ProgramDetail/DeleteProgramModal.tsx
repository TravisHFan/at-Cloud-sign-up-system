            ...
            >
              <div className="p-6">
                ...
                <p className="mt-2 text-sm text-gray-700">
                  This action cannot be undone. Choose how to handle the
                  program's linked events.
                </p>
                  ...
                  <label className="flex items-start gap-3 p-3 border rounded-md hover:bg-gray-50 cursor-pointer">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        {linkedEventsCount === 1 ? "event" : "events"}, and
                        remove their program association so these events become
                  ...
                  <label className="flex items-start gap-3 p-3 border rounded-md hover:bg-gray-50 cursor-pointer">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        action will delete everything under the events,
                        including registrations and guest registrations.
                      </div>
                    </div>
                  </label>
                </div>
